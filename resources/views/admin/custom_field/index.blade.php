                    ...
                    <div class="table-responsive mb-4 mt-4">
                        <table id="zero-config" class="table table-hover" style="width:100%">
                            ...
                            <tr>
                                ...
                                <td>{{ count($customField->childrens) }}</td>
                                <td>{{ $customField->postType?$customField->postType->title:null }}</td>
                                <td> @if($customField->status == "Active" ) <span class="badge badge-success">Active</span> @else <span class="badge badge-danger">Inactive</span> @endif</td>

                                <td>
                                    <a href="{{ route('admin.custom_field.edit', $customField->slug) }}" title="Edit" class="badge badge-success"> <i data-feather="edit"></i></a>
                                    <a href="{{ route('admin.custom_field.delete', $customField->slug) }}" title="Delete" class="badge badge-dark warning confirm"><i data-feather="archive"></i></a>

                                    <a href="{{ route('admin.custom_field.field_position', $customField->slug) }}" title="Delete" class="badge badge-primary">Field Position</a>
